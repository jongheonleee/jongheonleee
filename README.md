...
> - 건설 안전 도메인 Multi Agent System 초기 설계 및 구축(총 8~10개 모델 활용, 자사 플랫폼 연동, ...) 
> - LLM PEFT(QLoRA) 튜닝 및 MLflow 기반 MLOps 구축
> - Claude Code + Codex 기반 하네스 엔지니어링 프로젝트 적용 및 개발 방법론 사내 공유(기존 9명이서 진행하던 프로젝트 4명이서 운영)
...
>   - 발표 영상 링크: (추후에 첨부할 계획)
> - (3) 회사 전담 프로젝트 Claude Code 기반 테스트 자동화 및 품질 개선 
>   - 발표 자료 링크:  
> - (4) ReAct 논문 리뷰 
...
## [4] Side Projects 
> - 동행, 소중한 사람과 함께 동행하는 지도 기반 앱 서비스(기획 중)
